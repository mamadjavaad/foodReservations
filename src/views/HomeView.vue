    ...
    <v-main class="d-flex align-center justify-center mt-14 mb-1">
      ...
      <div class="d-flex w-50 mb-5 rounded-xl container-xs " style="min-height: 440px;background-color: white;"
        ...
        <div class="w-75 rounded pa-7 content-xs">
          ...
          <form class="py-4">
            <v-text-field class="mb-2" clearable label="شماره دانشجویی" name="username" type="username" required
              oninvalid="this.setCustomValidity('لطفا شماره دانشجویی خود را به درستی وارد کنید')"
              oninput="this.setCustomValidity('')"></v-text-field>

            <v-text-field clearable label="رمز عبور" type="password" name="password" required
